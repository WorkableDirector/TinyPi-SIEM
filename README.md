# TinyPi-SIEM
TinyPi is a lightweight SIEM software that allows you to view and monitor threats, vulnerabilities, and more using a Raspberry Pi or any other machine running an Ubuntu-based distribution.
